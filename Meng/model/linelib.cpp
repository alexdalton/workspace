...
void line_trainer_edge::train_sample(int mode, real alpha, real *_error_vec, real *_error_p, real *_error_q, double (*func_rand_num)(), unsigned long long &rand_index)
{
...
void line_trainer_edge::train_sample_depth(int mode, real alpha, int depth, real *_error_vec, real *_error_p, real *_error_q, double (*func_rand_num)(), unsigned long long &rand_index)
{
